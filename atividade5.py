...
#uma loja tem como politica comercial de aplicar uma margem bruta 45%  quando o preço de custo e menor ou igual a 100, se um produto custa mais doque isso a margem bruta e de 35%
...
preco = input("qyual e o valor do produto")
if  preco <= 100 :
